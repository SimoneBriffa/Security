...
public class SecurityApplication {
	...
	/*Il seguente Bean è in effetti fondamentale in quanto permette la comunicazione con il frontend e
	 * rende accessibile il token. Senza questa configurazione accade che il token risulti "null" sul frontend
	 */
