...
public class ExceptionHandling /*implements ErrorController */{
	...
	/*L'implementazione dell'interfaccia ErrorController è utile alla gestione
	 * dell'eccezione riguardante la richiesta di un endpoint inesistente.
	 * Un'alternativa alla sua implementazione (un solo metodo) è l'aggiunta
	 * di un ExceptionHandling su NoResultException
	 */
	...
	public ResponseEntity<HttpResponse> emailNotFoundException(UsernameExistsException exception){
	...
	public ResponseEntity<HttpResponse> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException exception){
		/*questa è un'eccezione nel caso si utilizzi un'operazione rest sbagliata */
		HttpMethod supportedMethod = Objects.requireNonNull(exception.getSupportedHttpMethods()).iterator().next();
		//l'iterator è dovuto al fatto che la funzione restituisce un Set
	...
	/*
	Questa eccezione gestisce la ricerca di un endpoint non valido.
	Va usata in addizione delle seguenti due righe al file application.properties
	...
	*/
	...
	public ResponseEntity<HttpResponse> notFound404(IOException exception){
		...
		return createHttpResponse(HttpStatus.NOT_FOUND, "This resource does not exists");	
	}
